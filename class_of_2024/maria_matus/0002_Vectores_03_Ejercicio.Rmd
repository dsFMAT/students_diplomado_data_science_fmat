...
names(acuaticos_vector)<-nombres_semana
names(tenis_vector)<-nombres_semana
```
```{r}
acuaticos_vector
tenis_vector
...
```{r}
# Escribe aquí tu resultado...
total_dias <- acuaticos_vector + tenis_vector
total_dias
...
```{r}
# Escribe aquí tu resultado...
sum(sum(acuaticos_vector), sum(tenis_vector))
sum(total_dias)
```
...
```{r}
# Escribe aquí tu resultado...
total_acuaticos<-sum(acuaticos_vector)
total_acuaticos
...
```{r}
# Escribe aquí tu resultado...
acua_tenis<-c(acuaticos_vector, tenis_vector)
mean(acua_tenis)
