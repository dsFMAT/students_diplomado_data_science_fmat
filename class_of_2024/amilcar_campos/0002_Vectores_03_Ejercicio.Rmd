...
```{r}
# Escribe aquí tu resultado...
dias_sem <- c("lunes","martes","miercoles","jueves","viernes")
names(acuaticos_vector) <- dias_sem
names(tenis_vector) <- dias_sem
```
...
```{r}
# Escribe aquí tu resultado...
acuaticos_profit <- sum(acuaticos_vector)
tenis_profit <- sum(tenis_vector)
```
...
```{r}
# Escribe aquí tu resultado...
total_profit <- sum(c(acuaticos_profit,tenis_profit))
```
...
```{r}
# Escribe aquí tu resultado...
print(names(acuaticos_vector[acuaticos_vector>0]))
```
...
```{r}
# Escribe aquí tu resultado...
print(names(tenis_vector[tenis_vector>0]))
```
...
```{r}
# Escribe aquí tu resultado...
print(mean(c(acuaticos_vector,tenis_vector)))
```
