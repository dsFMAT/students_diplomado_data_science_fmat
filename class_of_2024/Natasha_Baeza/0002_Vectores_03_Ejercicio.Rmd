...
names(acuaticos_vector)<- dias
names(tenis_vector)<-dias
```
...
```{r}
# Escribe aquí tu resultado...
profit_diario<-acuaticos_vector+tenis_vector
profit_diario
```
...
```{r}
# Escribe aquí tu resultado...
profit_total <- sum(profit_diario)
profit_total
...
```{r}
# Escribe aquí tu resultado...
profit_total_acuatico<-sum(acuaticos_vector)
profit_total_acuatico
...
```{r}
# Escribe aquí tu resultado...
profit_total_tenis<-sum(tenis_vector)
profit_total_tenis
...
```{r}
# Escribe aquí tu resultado...
dias_ganancias_acuatico<-dias[acuaticos_vector>0]
dias_ganancias_acuatico
...
```{r}
# Escribe aquí tu resultado...
dias_ganancias_tenis<-dias[tenis_vector>0]
...
```{r}
# Escribe aquí tu resultado...
prom_profit_acuatico<-mean(acuaticos_vector)
prom_profit_acuatico
...
```{r}
# Escribe aquí tu resultado...
prom_profit<-mean(profit_diario)
prom_profit
...
```{r}
# Escribe aquí tu resultado...
prom_ganancias_tenis<-mean(tenis_vector[tenis_vector>0])
prom_ganancias_tenis
